...
def load_data_mat(filename: str, max_samples: int,
                  seed=42) -> (np.ndarray, np.ndarray):
    '''
...
def load_svhn(folder: str, max_train: int,
              max_test: int) -> (np.ndarray, np.ndarray,
...
def random_split_train_val(X: np.ndarray, y: np.ndarray, num_val: int,
                           seed=42) -> (np.ndarray, np.ndarray,
                                        np.ndarray, np.ndarray):
    '''
